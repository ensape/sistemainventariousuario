...
const Editbobina = ({bobina}) => {
    ...
    const formik = useFormik({ // const handleChange  : aceptacion y validacion de lectura de los datos en el formulario
        ...
        validationSchema: Yup.object({
            ...
            costodolarfactura: Yup.string().min(1, ' Agregar la ostodolarfactura ')
                .required('La ostodolarfactura es obligatorio / En caso de no tener dato = 00.00'),

            costodolarprorroteado: Yup.string().min(1, ' Agregar la costodolarprorroteado ')
                .required('La costodolar prorroteado es obligatorio / En caso de no tener dato = 00.00'),

            costomn: Yup.string().min(1, ' Agregar la costo mn ')
                .required('La costo mn es obligatorio / En caso de no tener dato = 00.00'),

            pesoNeto: Yup.string().min(1, ' Agregar la pesofisicokilogramo ')
        ...
        onSubmit: bobina => { // pasar automaticamnete los datos del formulario
            console.log(bobina);
                ...
                try {
                    ...
                    fetch(`http://localhost:3001/bobina/update/${id}`, solicitudInit)
                        .then(res => res.text())
        ...
        <>
            <div class="font-sans">
                <div class="relative flex flex-col justify-center min-h-screen overflow-hidden">
                    ...
                    <h1 className="text-3xl font-light mb-4"> Ingresar Datos Para Actualizar Bobina </h1>
                        ...
                        <form
                            ...
                            <input
                                ...
                                value="Guardar Cambios de Bobina"
