...
const Editcortefleje = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            calibre: Yup.string().min(1, 'Agregar medida del calibre de la bobina ')
                .required('El calibre es obligatorio / En caso de no tener dato = 00100'),

            espesormilimetros: Yup.number().min(1, ' Agregar las medidas del espesor ')
                .required('El espesor en milimetros es obligatorio / En caso de no tener dato = 00100'),
            ...
            medida: Yup.number().min(2, ' Agregar las medidas en milimetros de fleje ')
                .required('El espesor real es obligatorio / En caso de no tener dato = 00100 '),

            pesoNeto: Yup.number().min(2, ' Agregar los kilogramos ')//
                .required('El stock kilogramo es obligatorio / En caso de no tener dato = 00100'),
            ...
            tipocambio: Yup.number().min(2, ' Ingresar el tipo de cambio ') //
                .required('El tipo cambio es obligatorio / En caso de no tener dato = 00100'),

            // pesokilogramofisico: Yup.number().min(2, ' Agregar el peso kilogramo en fisico ')
            //     .required('El peso kilogramo en fisico / En caso de no tener dato = 00100'),

            cantidad: Yup.number().min(2, ' Agregar la cantidad de fleje ')
                .required('La cantidad de fleje es obligatorio / En caso de no tener dato = 00100'),

            tubosporcorte: Yup.number().min(2, ' Ingresar cantidad de tubos por corte ')
                .required('La cantidad de tubos por corte es obligatorio / En caso de no tener dato = 00100'),
        ...
        onSubmit: fleje => {
            ...
            try {
                ...
                fetch(`http://localhost:3001/fleje/update/${id}`, solicitudInit)
    ...
    return (
        ...
        <>
            <h1 className="text-3xl font-light mb-4"> Ingresar Datos Para Actualizar El Corte Del Fleje </h1>
                        ...
                        <form
                            ...
                            <div className="mb-4">
                                ...
                                >
                                    ...
                                    <option value= "T-321      ">  T-321       </option>
                            ...
                            <input
                                ...
                                value="Guardar Cambios de Corte Fleje"
                            >
                            </input>
                        </form>
                    </div>
